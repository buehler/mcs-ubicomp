...
public class ARETTGazeDataHandler : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //print("IsEyeTrackingEnabled: " + InputSystem.EyeGazeProvider.IsEyeTrackingEnabled);
    ...
    public void StartCollectingGazeData()
    {
        ...
        Debug.Log("-- StartCollectingGazeData");
    ...
    {
        StopArettData();
        Debug.Log("-- StopCollectingGazeData");
        DebugText.text += $"\n[{DateTime.UtcNow.ToString("yyyy-MM-dd HH:mm:ss")}]";
    ...
    private void StopArettData()
    {
        ...
        print("unsubscribed to ARETT events");
